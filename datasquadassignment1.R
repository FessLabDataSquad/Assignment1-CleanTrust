...
# also, eventually we won't want to load the full raw files (as above) -- probably we can just create the merged file as a new object without making an object for the raw file -- it can just read data from it
